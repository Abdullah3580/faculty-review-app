...
import FacultyRatingChart from "@/components/FacultyRatingChart"; // আপনার তৈরি করা চার্ট
...
export default async function FacultyProfilePage(props: Props) {
  ...
  // ১. ফ্যাকাল্টি এবং তার সব রিভিউ নিয়ে আসা
  const faculty = await prisma.faculty.findUnique({
    where: { id: params.id },
    include: {
      reviews: {
        include: {
          user: true, // রিভিউ দাতার নাম (Nickname) দেখানোর জন্য
        },
        orderBy: {
          createdAt: "desc", // লেটেস্ট রিভিউ আগে দেখাবে
        },
      },
    },
  });
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1 space-y-6">
             {/* ✅ আপনার তৈরি করা চার্ট এখানে বসানো হলো */}
                  ...
                  <div key={review.id} className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition">
                    <div className="flex justify-between items-start mb-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          {/* User Nickname (Link to profile) */}
                          <Link href={`/student/${review.userId}`} className="font-bold text-gray-800 dark:text-white hover:text-indigo-500">
